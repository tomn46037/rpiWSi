...
def draw_data(screen,page,data,angle):
    ...
    draw_text(screen,text,'fonts/calibrib.ttf',80, 0,  0, screen_width,"center",WHITE,BACK)
   ...
   #forecast today
    ...
    xx=238
    pygame.draw.line(screen, (100,100,100), (xx,00), (xx,180))
    pygame.draw.line(screen, (100,100,100), (00,180), (xx,180))
