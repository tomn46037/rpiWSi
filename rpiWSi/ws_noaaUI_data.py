...
def get_wu_data(wu_api_key,wu_gps_coordinates,wu_language='EN',wu_icon_set='k'):
    ...
    try:
        ...
        wu_data["time_0"]=forecast_time[0].replace('Morning', 'AM').replace('Night', 'PM')
        ...
        wu_data["time_1"]=forecast_time[1].replace('Morning', 'AM').replace('Night', 'PM')
        ...
        wu_data["time_2"]=forecast_time[2].replace('Morning', 'AM').replace('Night', 'PM')
        ...
        wu_data["time_3"]=forecast_time[3].replace('Morning', 'AM').replace('Night', 'PM')
